...
import SourceName from "/src/components/Global/SourceName";
...
class ResultListItem extends Component {
  ...
  render() {
    ...
    if (!isScrolling) {
      ...
      photoContainerClass = classNames("PhotoContainer", {
      ...
      <div className="ResultListItem-Wrapper" style={style}>
        ...
        >
          <div className="Details-Container">
            <div className={photoContainerClass} style={photoContainerStyle}>
              {!isScrolling && (
                <>
                  <a
                    href={uploadLink}
            ...
            <div className="Details-Container-Expanded">
              <div className="Details-Text">
                ...
                <a
                  href={
                    item.get("editLink")
                      ? item.get("editLink").replace("&action=edit", "")
                      : "#"
                  }
                  target="_blank"
                  rel="noopener noreferrer"
